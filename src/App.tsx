...
function App() {
  ...
  if(!user.isAuthorized){
    return <RegistrationForm value={user} onUserChangeHandler={onUserChangeHandler}  onAuthorizedChange={onAuthorizedChange} />
  } else if (!destination.isAdded){
    return <AddDestinationForm onChangeHandler={addDestinationInputChange} value={destination.destinationId} onClickHandler={addDestinationClickButton}/>
  } else{
